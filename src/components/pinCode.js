    ...
    renderItemCell = ({ item, index }) => {
        ...
        if (index === 9) {
            ...
            return (
                ...
                >
                    <Image source={require('../../assets/images/pinCode/delete.png')} style={styles.deleteIcon} />
                </TouchableOpacity>
            );
        } else {
            return (
        ...
        return (
            <View style={styles.container}>
                <TouchableOpacity style={styles.close} onPress={() => this.props.onCloseView()} >
                    <Image source={require('../../assets/images/pinCode/cross.png')} style={[styles.icon, { tintColor: closeButtonColor || '#FF0000' }]} />
                </TouchableOpacity>
