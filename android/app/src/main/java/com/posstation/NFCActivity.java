...
public class NFCActivity extends ReactActivity {
    ...
    NFCActivity.AutoTestThread mAutoThread= null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_btn_autoTest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                if(0 == gl_autoRun)
                {
                    ...
                    mAutoThread = new NFCActivity.AutoTestThread();
                    mAutoThread.start();
                }
                else
                {
        ...
        m_btn_clean.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                m_text.setText("");
        ...
        grp_serialType.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
        ...
        grp_devType.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup arg0, int arg1) {
                // TODO Auto-generated method stub
                int radioButtonId = arg0.getCheckedRadioButtonId();
        ...
        grp_cardType.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener(){
